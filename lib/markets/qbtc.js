...
var end_url = exchange.toUpperCase() + '&symbol=' + coin.toUpperCase();

function get_summary(coin, exchange, cb) {
    var req_url = base_url + '/topQuotations.do?tradeMarket=' + end_url;
...
function get_trades(coin, exchange, cb) {
    var req_url = base_url + '/recentDealList.do?tradeMarket=' + end_url;
...
function get_orders(coin, exchange, cb) {
    var req_url = base_url + '/depthTable.do?tradeMarket='+ end_url;
