var mongoose = require('mongoose')
  ...
  , qbtc = require('./markets/qbtc')
  , probit = require('./markets/probit');
...
function get_market_data(market, cb) {
  switch(market) {
    ...
    case 'empoex':
      ...
      break;
    case 'qbtc':
      qbtc.get_data(settings.markets.coin.toLowerCase(), settings.markets.exchange.toLowerCase(), function(err, obj){
        return cb(err, obj);
      });
      break;
    case 'probit':
      probit.get_data(settings.markets.coin, settings.markets.exchange, function(err, obj){
        return cb(err, obj);
      });
      break;
    default:
